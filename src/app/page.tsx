        ...
        <footer className="bg-slate-900 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-bold text-lg">Tax Gains Calc</span>
                </div>
            ...
            <div className="text-center text-slate-400 text-sm">
              <p>&copy; {new Date().getFullYear()} Tax Gains Calc. All rights reserved.</p>
              <p className="mt-2">For informational purposes only. Not professional tax advice.</p>
              <p className="mt-2 text-slate-500">Contact: taxgainscalc@gmail.com</p>
            </div>
          </div>
        </footer>
      </div>
